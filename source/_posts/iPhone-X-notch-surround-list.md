...
![](http://cdn.objcer.com/4E124A83-5DD5-44C1-AA71-9394E34E8C57.png)
...
## DOM 结构
![](http://cdn.objcer.com/D75661B5-C160-4906-826D-E7908AA9B237.png)
```
<div class="outer">
    <div class="inner">
      <ul>
...
![](http://cdn.objcer.com/840F60D8-1D25-4B1C-BF50-C9F79DCC2AC9.png)
...
![](http://cdn.objcer.com/F772D60E-E17B-434F-A970-053BB77E53BB.png)
...
![](http://cdn.objcer.com/CB366BB3-C658-4514-96F7-103F5B712AD6.png)

这两个变量表征当前这一行列表距离上下刘海边界的位置，在滚动过程中根据 `distFromTop` 和 `distFromBottom` 变量触发不同的位移逻辑。

### 位移逻辑
分析**上方列表移动进入/离开刘海区域**时，列表位移的逻辑。
![](http://cdn.objcer.com/7B8867D1-1A5E-4DE6-A6CB-5B64209808F2.png)
![](http://cdn.objcer.com/E875669C-BEBE-4B6E-A883-EACF4CF29D63.png)
...
在此处，我们可以简化理解，如下图
![](http://cdn.objcer.com/94A6750A-B927-4B11-8446-8F92DCFA7747.png)
...
![](http://cdn.objcer.com/iPhone%20X%20list.gif)
